  ...
  return (
    ...
    <div className='py-32'>
      <div className='py-12 text-white flex items-center gap-32'>
        ...
        <p className=' w-[18%] self-end mb-3 text-xl font-medium'>Create a Professional
            Website Today <span className='text-[#D0FF71]'>!</span></p>
      </div>

      <div className='text-white  '>
        <p className='text-7xl tracking-[0.3rem] -mt-9'>TOMORROW TODAY</p>

        <p className='text-[#D0FF71] flex justify-end w-[75%] py-3'>POWERFUL HTML Template</p>
      </div>
    </div>
    </>
  )
